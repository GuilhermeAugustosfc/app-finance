...
const ExpanseList = () => {
  const [list, setList] = useState({ gastos: [] });
  // const data = {
  //   gastos: [
  ...
  function onMicrophoneResult(value) {
    console.log("olha o valor aqui");
    console.log(value);
    setList(value);
  }
  ...
  return (
    ...
    >
      <Calender />
      <MicrophoneComponent onMicrophoneResult={onMicrophoneResult} />
      <List data={list.gastos} />
    </View>
  );
};
